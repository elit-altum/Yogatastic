	...
	(b = "0.8.5"),
		...
		(function () {
			...
			for (
				...
				(e.requestAnimationFrame = e["" + d + "RequestAnimationFrame"]),
			...
			return (
				...
				(this.handleResult = function (a) {
					...
					return _.isFunction((c = this.onresult))
						? ((d = null != (e = a.outcome) ? e.intent : void 0),
						  (b = null != (f = a.outcome) ? f.entities : void 0),
						  c.call(window, d, b, a))
						: void 0;
				}),
				a &&
					...
					return (
						...
						this.elem
							? ((i = getComputedStyle(c)),
							  ...
							  (j = 1),
							  (h =
									(null != (n = window.performance) ? n.now() : void 0) ||
									new Date()),
							  (k = (function (c) {
									return function (i) {
										var n, o, p, q;
						...
						(d.onmessage = (function (a) {
							return function (b) {
								...
								return (
									...
									(d = e[0]),
									(c = e[1]),
									c ? a.fsm.call(a, d, c) : a.fsm.call(a, d)
								);
							};
						})(this)),
						(this.conn = d),
						(f = (function (a) {
							return function (b) {
								...
								return (
									...
									(d = (c.createScriptProcessor || c.createJavascriptNode).call(
										c,
										4096,
										1,
										1
